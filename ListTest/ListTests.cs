...
namespace ListTest
{
    ...
    public class ListTests
    {
        ...
        public void TestLength()
        {
            ...
            Assert.AreEqual(ListSize, list.Lenght(), "Incorrect length!");
        }
        ...
        public void TestListValidity()
        {
            ...
            bool works = list.First().dataNode == "one";
            works = works & list.First().nextNode.dataNode == "two";
            works = works & list.First().nextNode.nextNode.dataNode == "three";
